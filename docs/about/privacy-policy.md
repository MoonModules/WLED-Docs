...
# WLED and WLED-MM Privacy Policy (EU GDPR-Compliant)


## 1. Introduction
This Privacy Policy describes how the WLED Open Source Software (“WLED”, “WLED-MM”, “the Software”) processes technical data when it is installed and run on a device. WLED is designed to operate locally and does not intentionally collect, transmit, or store personal data (as defined under the EU General Data Protection Regulation (GDPR)).
